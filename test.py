...
def main(args):
    ...
    if calib_info is not None and img is not None:
        ...
        save_path = os.path.join("./result", ckpt_name, img_num + ".png")
...
if __name__ == '__main__':
    for num in range(0, 1000):
        ...
        args.pc_path = os.path.join("./kitti/training/velodyne_reduced", img_num + ".bin")
        args.calib_path = os.path.join("./kitti/training/calib/", img_num + ".txt")
        args.img_path = os.path.join("./kitti/training/image_2/", img_num + ".png")
        args.gt_path = os.path.join("./kitti/training/label_2/", img_num + ".txt")
